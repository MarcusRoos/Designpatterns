//------------------------------------------------------------------------------
// PowerSourceAdapters.cpp DT063G Design Patterns With C++
// Implementation of adapters classes
//------------------------------------------------------------------------------

#include <iostream>
#include "../include/PowerSourceAdapters.h"
...
bool FuelCellAD::incPower(int p) {
    return FuelCell::regulator.setElectricPower(
            FuelCell::regulator.getElectricPower() + p);
}
